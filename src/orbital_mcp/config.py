...
def default_profiles() -> list[HarnessProfile]:
    return [
        ...
        HarnessProfile(
            id="claude_code_acp_local",
            display_name="Claude Code local subscription",
            adapter="acp",
            ...
            classification=ProfileClassification(
                ...
                strengths=["general coding and explanation tasks"],
                limits=["ACP command availability varies by installation"],
                max_recommended_scope="medium",
                cost_preference="subscription_preferred",
                locality="subscription",
            ),
            support=ProfileSupport(tier="profile_template", notes=["Template until Claude Code ACP behavior is verified."]),
        ),
        HarnessProfile(
